	...
	BlockNumber: sp_runtime::traits::BlockNumber,
{
	...
	pub fn get_moon_type(&self) -> u8 {
		self.inner.get_segment_attribute_of_one(5, 4, 4)
	}
	...
	pub fn set_moon_type(&mut self, value: u8) {
		...
		let value = min(value, 0b_1111);
		self.inner.set_segment_attribute_of_one(5, 4, 4, value);
	}

	/// temperature --> [(6, 0, 4)]
	pub fn get_temperature(&self) -> u8 {
		self.inner.get_segment_attribute_of_one(6, 0, 4)
	}
	...
	pub fn set_temperature(&mut self, value: u8) {
		...
		let value = min(value, 0b_1111);
		self.inner.set_segment_attribute_of_one(6, 0, 4, value);
	}

	/// humidity --> [(6, 4, 4)]
	pub fn get_humidity(&self) -> u8 {
		self.inner.get_segment_attribute_of_one(6, 4, 4)
	}
	...
	pub fn set_humidity(&mut self, value: u8) {
		...
		let value = min(value, 0b_1111);
		self.inner.set_segment_attribute_of_one(6, 4, 4, value);
	}
	...
	pub fn get_resource(&self, resource_idx: u8) -> u8 {
		...
		self.inner.get_segment_attribute_of_one(byte_idx as usize, bit_idx, 1)
	}
	...
	pub fn set_resource(&mut self, resource_idx: u8, value: u8) {
		...
		self.inner.set_segment_attribute_of_one(byte_idx as usize, bit_idx, 1, value);
	}
	...
	pub fn get_is_ship_harvesting(&self) -> bool {
		self.inner.get_segment_attribute_of_one(20, 5, 1) != 0
	}

	/// isShipHarvesting --> [(20, 5, 1)]
	pub fn set_is_ship_harvesting(&mut self, value: bool) {
		self.inner.set_segment_attribute_of_one(20, 5, 1, value as u8);
	}

	/// isFinishedHarvesting --> [(20, 6, 1)]
	pub fn get_is_finished_harvesting(&self) -> bool {
		self.inner.get_segment_attribute_of_one(20, 6, 1) != 0
	}

	/// isFinishedHarvesting --> [(20, 6, 1)]
	pub fn set_is_finished_harvesting(&mut self, value: bool) {
		self.inner.set_segment_attribute_of_one(20, 6, 1, value as u8);
	}

	/// isShipPresent --> [(20, 7, 1)]
	pub fn get_is_ship_present(&self) -> bool {
		self.inner.get_segment_attribute_of_one(20, 7, 1) != 0
	}

	/// isShipPresent --> [(20, 7, 1)]
	pub fn set_is_ship_present(&mut self, value: bool) {
		self.inner.set_segment_attribute_of_one(20, 7, 1, value as u8);
	}

	/// isTravelPointMintable --> [(21, 1, 1)]
	pub fn get_is_travel_point_mintable(&self) -> bool {
		self.inner.get_segment_attribute_of_one(21, 1, 1) != 0
	}

	/// isTravelPointMintable --> [(21, 1, 1)]
	pub fn set_is_travel_point_mintable(&mut self, value: bool) {
		self.inner.set_segment_attribute_of_one(21, 1, 1, value as u8);
	}
